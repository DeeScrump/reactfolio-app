    ...
    return (
        <footer className="bgImage">
            <div className='d-inline-flex nav nav-tabs'>
                ...
                <a className="nav-item link-warning" href="mailto:dwight.kornbluth@gmail.com" alt="Email"><img className="iconImage" src={emailMe} alt="dwight.kornbluth@gmail.com"/></a>
