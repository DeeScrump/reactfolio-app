...
import encryptionRealness from "../assets/passwordgen.png";
        ...
        <div className="row">
            ...
            <div className="row">
                ...
                <div className="card p-0 border-0 col-lg m-4 shadowBox">
                    ...
                    <img className="card-img" src={encryptionRealness} alt="Encryption Realness Screenshot"/></a>
            ...
            <div className="row">
                ...
                <div className="card p-0 border-0 col-lg m-4 shadowBox">
                    ...
                    <img className="card-img" src={blogginTech} alt="S3 Landing Page"/></a>
                    <header className="cardhead2"><a className="border-0 m-0 p-0" href="https://github.com/DeeScrump/BlogginBoutTech.git" alt="Repository" target="_blank" rel="noreferrer">Github Repository</a></header>
                </div>
            </div>
